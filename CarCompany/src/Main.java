...
public class Main {
    public static void main(String[] args) {
        ...
        Permanent emp1 = new Permanent(1, "fatima", "Guebli", "babez", new Date(2004, Calendar.MARCH, 16), "software engineer", BEA);
        Permanent emp2 = new Permanent(2, "Meriem", "Gbl", "Bananniers", new Date(2006, Calendar.MARCH, 3), "chemist", BEA);

        Contractor emp3 = new Contractor(3, "Mohamed", "Sid Ali", "Zerhoni", new Date(2012, Calendar.AUGUST, 1), "Doctor", BEA, new LinkedList<ContractEmployment>());
        Contractor emp4 = new Contractor(4, "Hadjer", "Ha", "bab ezzouar", new Date(2015, Calendar.JUNE, 1), "teacher", BEA, new LinkedList<ContractEmployment>());
        ...
        System.out.println("his contracts : \n");
        ...
        ContractCar carContract1 = new ContractCar(15,new Date(2024, Calendar.SEPTEMBER,1), "bon", new Date(2026, Calendar.MARCH, 5), "", emp3, car1);
